...
class EvaluationUtilsTest(tf.test.TestCase):
  ...
  def testEvaluate(self):
    output = "tensor2tensor/models/tfnmt/nmt/testdata/deen_output"
    ref_bpe = "tensor2tensor/models/tfnmt/nmt/testdata/deen_ref_bpe"
    ref_spm = "tensor2tensor/models/tfnmt/nmt/testdata/deen_ref_spm"
  ...
  def testAccuracy(self):
    pred_output = "tensor2tensor/models/tfnmt/nmt/testdata/pred_output"
    label_ref = "tensor2tensor/models/tfnmt/nmt/testdata/label_ref"
