...
try:
    ...
    logging.error("This problem requires the installation of additional "
...
def maybe_get_section_list(data_root, 
    ...
    logging.info("Getting section list with criteria, num rows: "
...
def maybe_get_image_list(section_dataset_id, 
    ...
    if os.path.exists(section_list_path):
        logging.info("Image list found for section id "
